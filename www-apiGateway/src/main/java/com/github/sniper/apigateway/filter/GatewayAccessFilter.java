package com.github.sniper.apigateway.filter;

import cn.hutool.core.collection.CollectionUtil;
import com.alibaba.fastjson.JSONObject;
import com.github.sniper.apigateway.security.SniperSecurityProperties;
import com.github.sniper.common.toolkit.StopWatch;
...
public class GatewayAccessFilter implements GlobalFilter, Ordered {
    ...
    @Autowired
    SniperSecurityProperties sniperSecurityProperties;
    ...
    private Boolean preValidateRequestPathHaveIngnoreAuth(ServerHttpRequest request) {
        ...
        Boolean result = Arrays.stream(sniperSecurityProperties.getIgnorePath()).noneMatch(param -> antPathMatcher.match(param, request.getPath().toString()));
...
//                return jsonObject;
            ...
            return restTemplate.postForObject(sniperSecurityProperties.getAuthUrl() + request.getPath(),entity , JSONObject.class);
        }
    }
